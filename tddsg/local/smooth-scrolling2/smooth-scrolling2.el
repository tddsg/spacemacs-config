;;; smooth-scrolling2.el --- Make emacs scroll smoothly
;;
;; Copyright (c) 2007-2016 Adam Spiers
;;
;; Filename: smooth-scrolling2.el
...
;; Homepage: http://github.com/aspiers/smooth-scrolling2/
;; Version: 2.0.0
;; Keywords: convenience
;; GitHub: http://github.com/aspiers/smooth-scrolling2/
...
;;
;;     M-x smooth-scrolling2-mode
;;
;; To make the mode permanent, put this in your .emacs:
;;
;;     (require 'smooth-scrolling2)
;;     (smooth-scrolling2-mode 1)
;;
...
;;; Change Log:
;; 27 Feb 2016 -- v2.0.0
;;      * Converted to global minor mode "smooth-scrolling2-mode". This
...
(defgroup smooth-scrolling2 nil
  "Make emacs scroll smoothly"
  :group 'convenience)

;;;###autoload
(define-minor-mode smooth-scrolling2-mode
  "Make emacs scroll smoothly"
  :init-value nil
  :global t
  :group 'smooth-scrolling2
  (if smooth-scrolling2-mode
...
`smooth-scrolling2-mode' is enabled."
  `(defadvice ,func (after smooth-scroll activate)
     "Do smooth scrolling after command finishes.

This advice only has an effect when `smooth-scrolling2-mode' is
enabled. See `smooth-scrolling2-mode' for details. To remove this
...
;;;_ + provide
(provide 'smooth-scrolling2)
;;; smooth-scrolling2.el ends here
